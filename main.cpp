...
int main() {
  ...
  run_generic_list_test_case_1();
  run_generic_list_test_case_2();
  run_generic_list_test_case_3();
  ...
  // Stack Test Cases
  run_stack_test_case_1();
  run_stack_test_case_2();
  run_stack_test_case_3();
